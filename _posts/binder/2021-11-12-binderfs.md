...
## 3.1. binder: prevent UAF for binderfs devices 
...
이것은 51d8a7eca677에 대한 대안 수정입니다("binder: print_binder_transaction_log_entry()에서 UAF 읽기 방지").

## 3.2. binder: prevent UAF for binderfs devices II
